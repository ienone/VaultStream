...
当前账号摘要和部分低频连接参数仍位于设置“账号与平台”分区。目标设计是按前端 IA 新建独立账号中心，集中承接连接、检测、解绑、权限和修复流程；设置只保留应用与系统配置。实施顺序以 `../../plans/2026-07-17-vaultstream-development-roadmap.plan.md` 为准。
