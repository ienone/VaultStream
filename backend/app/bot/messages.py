...
HELP_TEXT_FULL = (
    ...
    "/save &lt;链接或文字&gt; - 明确保存到 VaultStream\n"
    "也可以回复一条带文字、链接、图片、文件、音视频或语音的消息后单独发送 <code>/save</code>\n"
    "私聊可直接说“帮我保存 &lt;链接或文字&gt;”，或回复目标消息后说“保存”\n"
    "/ai &lt;指令&gt; - 自然语言调用 Agent（高风险操作会显示批准/拒绝按钮）\n"
