...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,platform,platformId,contentType,url,cleanUrl,status,reviewStatus,const DeepCollectionEquality().hash(tags),isNsfw,title,description,authorName,authorAvatarUrl,coverUrl,coverColor,createdAt,updatedAt,publishedAt,const DeepCollectionEquality().hash(mediaUrls),viewCount,likeCount,collectCount,shareCount,commentCount,const DeepCollectionEquality().hash(extraStats),const DeepCollectionEquality().hash(rawMetadata)]);

@override
String toString() {
  return 'ContentDetail(id: $id, platform: $platform, platformId: $platformId, contentType: $contentType, url: $url, cleanUrl: $cleanUrl, status: $status, reviewStatus: $reviewStatus, tags: $tags, isNsfw: $isNsfw, title: $title, description: $description, authorName: $authorName, authorAvatarUrl: $authorAvatarUrl, coverUrl: $coverUrl, coverColor: $coverColor, createdAt: $createdAt, updatedAt: $updatedAt, publishedAt: $publishedAt, mediaUrls: $mediaUrls, viewCount: $viewCount, likeCount: $likeCount, collectCount: $collectCount, shareCount: $shareCount, commentCount: $commentCount, extraStats: $extraStats, rawMetadata: $rawMetadata)';
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String platform, @JsonKey(name: 'platform_id')  String? platformId, @JsonKey(name: 'content_type')  String? contentType,  String url, @JsonKey(name: 'clean_url')  String? cleanUrl,  String status, @JsonKey(name: 'review_status')  String? reviewStatus,  List<String> tags, @JsonKey(name: 'is_nsfw')  bool isNsfw,  String? title,  String? description, @JsonKey(name: 'author_name')  String? authorName, @JsonKey(name: 'author_avatar_url')  String? authorAvatarUrl, @JsonKey(name: 'cover_url')  String? coverUrl, @JsonKey(name: 'cover_color')  String? coverColor, @JsonKey(name: 'created_at')  DateTime createdAt, @JsonKey(name: 'updated_at')  DateTime updatedAt, @JsonKey(name: 'published_at')  DateTime? publishedAt, @JsonKey(name: 'media_urls')  List<String> mediaUrls, @JsonKey(name: 'view_count')  int viewCount, @JsonKey(name: 'like_count')  int likeCount, @JsonKey(name: 'collect_count')  int collectCount, @JsonKey(name: 'share_count')  int shareCount, @JsonKey(name: 'comment_count')  int commentCount, @JsonKey(name: 'extra_stats')  Map<String, dynamic> extraStats, @JsonKey(name: 'raw_metadata')  Map<String, dynamic>? rawMetadata)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ContentDetail() when $default != null:
return $default(_that.id,_that.platform,_that.platformId,_that.contentType,_that.url,_that.cleanUrl,_that.status,_that.reviewStatus,_that.tags,_that.isNsfw,_that.title,_that.description,_that.authorName,_that.authorAvatarUrl,_that.coverUrl,_that.coverColor,_that.createdAt,_that.updatedAt,_that.publishedAt,_that.mediaUrls,_that.viewCount,_that.likeCount,_that.collectCount,_that.shareCount,_that.commentCount,_that.extraStats,_that.rawMetadata);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String platform, @JsonKey(name: 'platform_id')  String? platformId, @JsonKey(name: 'content_type')  String? contentType,  String url, @JsonKey(name: 'clean_url')  String? cleanUrl,  String status, @JsonKey(name: 'review_status')  String? reviewStatus,  List<String> tags, @JsonKey(name: 'is_nsfw')  bool isNsfw,  String? title,  String? description, @JsonKey(name: 'author_name')  String? authorName, @JsonKey(name: 'author_avatar_url')  String? authorAvatarUrl, @JsonKey(name: 'cover_url')  String? coverUrl, @JsonKey(name: 'cover_color')  String? coverColor, @JsonKey(name: 'created_at')  DateTime createdAt, @JsonKey(name: 'updated_at')  DateTime updatedAt, @JsonKey(name: 'published_at')  DateTime? publishedAt, @JsonKey(name: 'media_urls')  List<String> mediaUrls, @JsonKey(name: 'view_count')  int viewCount, @JsonKey(name: 'like_count')  int likeCount, @JsonKey(name: 'collect_count')  int collectCount, @JsonKey(name: 'share_count')  int shareCount, @JsonKey(name: 'comment_count')  int commentCount, @JsonKey(name: 'extra_stats')  Map<String, dynamic> extraStats, @JsonKey(name: 'raw_metadata')  Map<String, dynamic>? rawMetadata)  $default,) {final _that = this;
switch (_that) {
case _ContentDetail():
return $default(_that.id,_that.platform,_that.platformId,_that.contentType,_that.url,_that.cleanUrl,_that.status,_that.reviewStatus,_that.tags,_that.isNsfw,_that.title,_that.description,_that.authorName,_that.authorAvatarUrl,_that.coverUrl,_that.coverColor,_that.createdAt,_that.updatedAt,_that.publishedAt,_that.mediaUrls,_that.viewCount,_that.likeCount,_that.collectCount,_that.shareCount,_that.commentCount,_that.extraStats,_that.rawMetadata);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String platform, @JsonKey(name: 'platform_id')  String? platformId, @JsonKey(name: 'content_type')  String? contentType,  String url, @JsonKey(name: 'clean_url')  String? cleanUrl,  String status, @JsonKey(name: 'review_status')  String? reviewStatus,  List<String> tags, @JsonKey(name: 'is_nsfw')  bool isNsfw,  String? title,  String? description, @JsonKey(name: 'author_name')  String? authorName, @JsonKey(name: 'author_avatar_url')  String? authorAvatarUrl, @JsonKey(name: 'cover_url')  String? coverUrl, @JsonKey(name: 'cover_color')  String? coverColor, @JsonKey(name: 'created_at')  DateTime createdAt, @JsonKey(name: 'updated_at')  DateTime updatedAt, @JsonKey(name: 'published_at')  DateTime? publishedAt, @JsonKey(name: 'media_urls')  List<String> mediaUrls, @JsonKey(name: 'view_count')  int viewCount, @JsonKey(name: 'like_count')  int likeCount, @JsonKey(name: 'collect_count')  int collectCount, @JsonKey(name: 'share_count')  int shareCount, @JsonKey(name: 'comment_count')  int commentCount, @JsonKey(name: 'extra_stats')  Map<String, dynamic> extraStats, @JsonKey(name: 'raw_metadata')  Map<String, dynamic>? rawMetadata)?  $default,) {final _that = this;
switch (_that) {
case _ContentDetail() when $default != null:
return $default(_that.id,_that.platform,_that.platformId,_that.contentType,_that.url,_that.cleanUrl,_that.status,_that.reviewStatus,_that.tags,_that.isNsfw,_that.title,_that.description,_that.authorName,_that.authorAvatarUrl,_that.coverUrl,_that.coverColor,_that.createdAt,_that.updatedAt,_that.publishedAt,_that.mediaUrls,_that.viewCount,_that.likeCount,_that.collectCount,_that.shareCount,_that.commentCount,_that.extraStats,_that.rawMetadata);case _:
  return null;
...
class _ContentDetail extends ContentDetail {
  const _ContentDetail({required this.id, required this.platform, @JsonKey(name: 'platform_id') this.platformId, @JsonKey(name: 'content_type') this.contentType, required this.url, @JsonKey(name: 'clean_url') this.cleanUrl, required this.status, @JsonKey(name: 'review_status') this.reviewStatus, required final  List<String> tags, @JsonKey(name: 'is_nsfw') required this.isNsfw, this.title, this.description, @JsonKey(name: 'author_name') this.authorName, @JsonKey(name: 'author_avatar_url') this.authorAvatarUrl, @JsonKey(name: 'cover_url') this.coverUrl, @JsonKey(name: 'cover_color') this.coverColor, @JsonKey(name: 'created_at') required this.createdAt, @JsonKey(name: 'updated_at') required this.updatedAt, @JsonKey(name: 'published_at') this.publishedAt, @JsonKey(name: 'media_urls') final  List<String> mediaUrls = const [], @JsonKey(name: 'view_count') this.viewCount = 0, @JsonKey(name: 'like_count') this.likeCount = 0, @JsonKey(name: 'collect_count') this.collectCount = 0, @JsonKey(name: 'share_count') this.shareCount = 0, @JsonKey(name: 'comment_count') this.commentCount = 0, @JsonKey(name: 'extra_stats') final  Map<String, dynamic> extraStats = const {}, @JsonKey(name: 'raw_metadata') final  Map<String, dynamic>? rawMetadata}): _tags = tags,_mediaUrls = mediaUrls,_extraStats = extraStats,_rawMetadata = rawMetadata,super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,platform,platformId,contentType,url,cleanUrl,status,reviewStatus,const DeepCollectionEquality().hash(_tags),isNsfw,title,description,authorName,authorAvatarUrl,coverUrl,coverColor,createdAt,updatedAt,publishedAt,const DeepCollectionEquality().hash(_mediaUrls),viewCount,likeCount,collectCount,shareCount,commentCount,const DeepCollectionEquality().hash(_extraStats),const DeepCollectionEquality().hash(_rawMetadata)]);
