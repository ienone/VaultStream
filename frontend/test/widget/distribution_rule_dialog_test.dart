...
void main() {
  group('DistributionRuleDialog Widget Tests', () {
    testWidgets('DistributionRuleDialog - Create mode', (WidgetTester tester) async {
      tester.view.physicalSize = const Size(1920, 1080);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);

      await tester.pumpWidget(ProviderScope(
        child: MaterialApp(home: Dialog(child: DistributionRuleDialog(
          onCreate: (rule) {
      ...
      await tester.enterText(find.widgetWithText(TextFormField, '包含标签'), 'tag1');
    ...
    testWidgets('DistributionRuleDialog - Edit mode', (WidgetTester tester) async {
      tester.view.physicalSize = const Size(1920, 1080);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);
      ...
      // Add new tag
      await tester.enterText(find.widgetWithText(TextFormField, '包含标签'), 'new_tag');
      await tester.testTextInput.receiveAction(TextInputAction.done);
      await tester.pumpAndSettle();
